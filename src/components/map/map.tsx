      ...
      <Geographies geography={geoUrl}>
        {({ geographies }) =>
          geographies.map((geo) => {
            ...
            const isHovered = hoveredContinent === continent; // Check if the current continent is hovered
            ...
            return (
              <Geography
                ...
                style={{
                  default: {
                    fill: isHovered ? "#73bfb8" : "#D6D6DA", // Change color only for the hovered continent
                    outline: "none",
                  },
                  hover: {
                    fill: "#73bfb8", // Change color on hover
                    outline: "none",
                  },
                  pressed: {
                    fill: "#FF5722",
